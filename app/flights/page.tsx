...
// This is the inner component that accesses searchParams and fetches live backend data
function FlightResultsContent() {
  ...
  // Capturing search parameters from HeroSearchBox
...
// Default export wrapping content in Suspense for Next.js App Router
